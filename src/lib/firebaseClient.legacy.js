// LEGACY: Arquivado para referência. Não é utilizado na aplicação atual.
// O fluxo de Messaging está centralizado em `src/firebase.js` e `src/components/PushNotificationLayout.js`.
// Este arquivo pode ser removido após validação final.
